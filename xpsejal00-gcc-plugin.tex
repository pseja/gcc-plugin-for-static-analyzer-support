...
% Při tvorbě odevzdaného programového kódu jsem využíval nástroj Github Copilot. [konkretizujte a upravte podle skutečnosti].},
  ...
  I have used Grammarly to correct spelling and other language mistakes. 
  % I used GitHub Copilot when working on the software. [specify and ammend based on reality].
  },
