...
To prevent these bugs, developers must rely on advanced static analysis tools, such as the Predator shape analysis suite, which is capable of formally verifying a~program's state space without executing it~\cite{PredatorSuite2016}.
