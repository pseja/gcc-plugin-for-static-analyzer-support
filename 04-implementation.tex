...
To quantify the scale of the implementation and distinguish original thesis work from legacy code, the authored C and C++ implementation files outside the imported Predator subtree comprise 14,960 lines of code (LOC)\footnote{Measured in May 2026}.
The repository includes an additional 2,061 lines of automated test code, bringing the total authored contribution to 17,021 lines.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lr@{}}
    ...
    Exporters (\texttt{src/exporters/})          & 4,217  \\
    ...
    \midrule
    Total implementation code                    & 14,960 \\
    \bottomrule
  \end{tabular}
